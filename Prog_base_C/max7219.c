...
*********************************************************************************************************
* Module     : MAX7219.C
* Author     : Randy Rasa modifié par Alain REBOUX pour ST7 
...
*********************************************************************************************************
*/
#include <io7flit2.h>                                  // microcontroller header file
...
{
  PBDR=PBDR|4;                                          // take LOAD high to begin
  MAX7219_SendByte(reg_number);                       // write register number to MAX7219
  MAX7219_SendByte(dataout);                          // write data to MAX7219
  PBDR=PBDR&251;                                          // take LOAD low to latch in data
  PBDR=PBDR|4;                                          // take LOAD high to end
}
...
static void MAX7219_SendByte (unsigned char dataout)
{
   char temp;
	SPIDR=dataout;
	while (!(SPISR & 128))	// wait for conversion completed
		;
	temp=SPISR;	
	temp=SPIDR;
